...
import pers.lxk.smart4j.framework.bean.Data;
import pers.lxk.smart4j.framework.bean.Handler;
import pers.lxk.smart4j.framework.bean.Param;
import pers.lxk.smart4j.framework.bean.View;
...
import pers.lxk.smart4j.framework.util.*;
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (handler != null) {
            ...
            if (StringUtil.isNotEmpty(body)) {
                //StringUtil里没看到splitString方法暂时用StringUtils代替
            ...
            Param param = new Param(parmaMap);
            //调用Action方法
